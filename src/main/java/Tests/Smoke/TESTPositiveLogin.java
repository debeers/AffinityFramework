 ...
 */
public class TESTPositiveLogin extends BaseTest{

    @Test
    public void LoginPositive() throws InterruptedException, IOException, AWTException, SQLException {
        ...
        String tmp = new String($(userAccountPage.loggedInAccountLink).getText().getBytes(Charset.forName("utf-8")));
