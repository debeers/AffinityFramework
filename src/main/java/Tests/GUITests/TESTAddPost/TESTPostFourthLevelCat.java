 ...
 */
public class TESTPostFourthLevelCat extends BaseTest {

    @Test
    public void AddPostToFourthCategory() throws IOException, AWTException, InterruptedException {

        Properties props = new ResourcesFactory().getResources("AddPostToFourthCategory");
