 ...
 */
public class TESTLoginWithShortenedPhoneNumber extends BaseTest {

    @Test
    public void LoginWithShortenedPhoneNumber() throws InterruptedException, IOException {
        Properties props = new ResourcesFactory().getResources("LoginWithShortenedPhoneNumber");
